...
\usepackage{url}
\usepackage[backend=bibtex, style=authoryear, url=true]{biblatex}
...
\usepackage{hyperref}
\hypersetup{pdfkeywords = {},pdfstartview = {Fit},	colorlinks = {false},breaklinks = {true},bookmarksopen = {true}}
