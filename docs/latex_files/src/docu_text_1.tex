...
\begin{itemize}
	...
	\item \textbf{Boglarka Lehoczki:} My part was to create the UI with React. The most difficult was to learn how to use React with JSX, Bootstrap and Reactstrap and instantly use these according to the best practices to enable others to built on the top of my implementation.
